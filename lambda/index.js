...
const STREAM = [
    {
       'slot': 'general',
       'intro':'here is a video about Elodie and Theo. I hope you like it. ',
       'urlFile': 'Media/LaunchSkill-HD720p.mov',
       'prompt': '',
       'prompt2': ''
    },
    {
...
const LaunchRequestHandler = {
    ...
    handle(handlerInput) {
        videoIndex = 0;  // select general video
        let speakOutput = `Hello Jean. I am going to show you a short video showing your great grandchildren, Elodie and Theo. 
         It will take just a few seconds to get it ready. I hope you enjoy it. `;
        let videoClip = Util.getS3PreSignedUrl(STREAM[videoIndex].urlFile);
